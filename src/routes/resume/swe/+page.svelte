...
<div class="resume">
	<header>
		<h1>Alan Mooiman, performance-driven web engineer in NYC</h1>
		...
		<p>
			I'm interested in moving back to an IC role for now so that I can broaden and hone my
			technical skills in an area that I'm excited about. In addition to writing code, I enjoy
			driving technical excellence through goal-setting, making process improvements, and automating
			workflows that support departmental technical aims. I'm a proponent of leveraging the core web
			platform whenever possible, and regularly drive conversations across engineering teams about
			how we can improve our craft.
		</p>
	</header>
	<div class="content">
		<section class="metadata">
			...
			<p>
				<span id="managementTime">6+ years</span> of engineering management experience
			</p>
			<p>
				Internal advocate for web performance, accessibility, and technical debt reduction through
				consistent, low friction process change.
			</p>
		...
		<section class="roles">
			...
			<details open class="resume_item">
				...
				<ul>
					...
					<li>
						Set SLO's for performance across codebases and brought visibilty to those goals in
