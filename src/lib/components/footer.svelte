<footer>
	<ul class="elsewhere">
		<li>
			<a href="https://xoxo.zone/@Alanmoo" aria-label="Mastodon page"
				><svg
					width="2em"
					height="2em"
					stroke-width="2.3"
		...
		<li>
			<a href="https://www.instagram.com/alanmoo/" aria-label="Instagram profile"
				><svg
					width="2em"
					height="2em"
					stroke-width="2.3"
		...
		<li>
			<a href="https://linkedin.com/in/amooiman" aria-label="LinkedIn profile"
				><svg
					width="2em"
					height="2em"
					stroke-width="2.3"
